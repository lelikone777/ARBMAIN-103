    ...
    <style type="text/css">
        ...
        * {
        ...
        body {
            ...
            background-image: -moz-linear-gradient( -90deg, rgb(0,176,62) 0%, rgb(255,255,255) 40%);
            background-image: -webkit-linear-gradient( -90deg, rgb(0,176,62) 0%, rgb(255,255,255) 40%);
            background-image: -ms-linear-gradient( -90deg, rgb(0,176,62) 0%, rgb(255,255,255) 40%);
        }
