    ...
    <style type="text/css">
        ...
        * {
        ...
        body {
            ...
            background-image: -moz-linear-gradient( 90deg, rgb(124,55,0) 0%, rgb(255,115,0) 78%);
            background-image: -webkit-linear-gradient( 90deg, rgb(124,55,0) 0%, rgb(255,115,0) 78%);
            background-image: -ms-linear-gradient( 90deg, rgb(124,55,0) 0%, rgb(255,115,0) 78%);
        }
